...
const brands = [
  "MAC", "Lakmé", "Bobbi Brown", "Charlotte Tilbury", "Huda Beauty",
  "NARS", "Urban Decay", "Estée Lauder", "Maybelline", "L'Oréal",
  "Kryolan", "M·A·C Pro", "Fenty Beauty", "Too Faced",
];
  ...
  return (
    <section className="py-16 md:py-20 bg-background border-y border-border/50" ref={ref}>
      ...
      <div className="relative overflow-hidden">
        ...
        <div
          className={`flex animate-scroll-left transition-opacity duration-1000 ${
        ...
        >
          {[...brands, ...brands].map((brand, i) => (
            <div
              key={i}
              className="flex items-center justify-center px-8 md:px-12 py-4 shrink-0 group cursor-default"
            >
